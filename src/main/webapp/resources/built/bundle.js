...
var RootRoutes = function (_React$Component) {
    _inherits(RootRoutes, _React$Component);

    function RootRoutes() {
        _classCallCheck(this, RootRoutes);

        return _possibleConstructorReturn(this, (RootRoutes.__proto__ || Object.getPrototypeOf(RootRoutes)).apply(this, arguments));
    }
